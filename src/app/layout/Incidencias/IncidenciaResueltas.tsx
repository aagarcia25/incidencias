...
const IncidenciaResueltas = () => {
  ...
  const consulta = () => {
    setOpen(true);
    IncidenciasServices.Incidencias({}, 8).then((res) => {
      if (res.SUCCESS) {
        Toast.fire({
          icon: "success",
  ...
  return (
    <>
      <TitleComponent title={"Listado de Incidencias Resultas"} show={open} />
...
export default IncidenciaResueltas;
