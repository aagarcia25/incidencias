...
const IncidenciasPorValidar = () => {
  ...
  const consulta = () => {
    setOpen(true);
    IncidenciasServices.Incidencias({}, 9).then((res) => {
      if (res.SUCCESS) {
        Toast.fire({
          icon: "success",
  ...
  return (
    <>
      <TitleComponent title={"Listado En Validación"} show={open} />
...
export default IncidenciasPorValidar;
